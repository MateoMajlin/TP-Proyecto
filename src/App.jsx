...
function App() {
  ...
  return (
    <>
      {nombreUsuario && (
          <div className="user">
            ¡Bienvenido/a, {nombreUsuario} a los increibles 🎮JUEGOS K🎮!
          </div>
        )}
       <div className="k">
          <h1>🎮JUEGOS K🎮</h1>
      ...
      <div className="body">
        ...
        <br></br>
        <div className="juego">
          <Link to="https://www.macrojuegos.com/juegos/adventure-time-lemon-break~14801/ ">
            <img
              src="https://www.numuki.com/game/img/at-lemon-break-1919.jpg"
              alt="pikapika"
            />
          </Link>
        </div>
